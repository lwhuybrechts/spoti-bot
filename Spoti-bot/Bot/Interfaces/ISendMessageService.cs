...
namespace Spoti_bot.Bot.Interfaces
{
    public interface ISendMessageService
    {
        ...
        Task SendTextMessageAsync(Message messageToRespondTo, string text, ParseMode parseMode = ParseMode.Markdown, bool disableWebPagePreview = true, int replyToMessageId = 0, IReplyMarkup replyMarkup = null);
