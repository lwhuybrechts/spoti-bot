...
namespace SpotiBot.Api.Bot
{
    public class KeyboardService : IKeyboardService
    {
        ...
        public KeyboardService(Data.Services.IVoteService voteService, IOptions<AzureOptions> azureOptions)
        {
        ...
        /// </summary>
        public InlineKeyboardMarkup CreateSwitchToPmKeyboard(SpotiBot.Library.BusinessModels.Bot.Chat chat)
        {
