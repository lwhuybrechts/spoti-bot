...
namespace SpotiBot.Api.Spotify.Authorization
{
    public class AuthorizationService : IAuthorizationService
    {
        ...
        public async Task<SpotiBot.Library.BusinessModels.Spotify.LoginRequest> RequestAndSaveAuthorizationToken(string code, string loginRequestId)
        {
            ...
            var token = _mapper.Map(accessToken, loginRequest.UserId);

            // Save the token.
            await _authorizationTokenService.Upsert(token);
