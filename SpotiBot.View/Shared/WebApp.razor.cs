...
using IMapper = SpotiBot.Library.ApiModels.IMapper;

namespace SpotiBot.View.Shared
{
    public class WebApp : ComponentBase
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _stateContainer.SpotifyAccessToken = _mapper.Map(result.SpotifyAccessToken, result.UserId);
        }
    }
}